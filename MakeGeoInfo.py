...
def main():
    ...
    with open("GeoInfo", 'w') as fileID:
        ...
        # WriteOctagonSection(fileID, "section0 0.0 0.0", -3.0E0, -3.0E0, 3.0E0, 3.0E0,
        #                     ['N', 'N', 'N', 'N', 'N', 'N', 'N', 'N'],
        #                     [0.0E0, 0.0E0, 0.0E0, 0.0E0, 1.0E3, 0.0E0, 0.0E0, 0.0E0])
        # WriteOctagonSection(fileID, "section1 0.0 0.0", -1.5E0, -1.5E0, 1.5E0, 1.5E0,
        #                     ['D', 'D', 'D', 'D', 'D', 'D', 'D', 'D'],
        #                     [0.0E0, 0.0E0, 0.0E0, 0.0E0, 1.0E3, 0.0E0, 0.0E0, 0.0E0])
        ...
        # WriteRegion(fileID, "Region0", 1.0E0, -3.0E0 - translation_const, -3.0E0 - translation_const / 3.14,
        #             3.0E0 + translation_const, 3.0E0 + translation_const, h, h, '+', "section0", '-', "section1")
