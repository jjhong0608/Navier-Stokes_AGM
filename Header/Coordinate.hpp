...
Coordinate &Coordinate::SetCoordinate(char coord, double value) {
    ...
    if (this->Dimension() == 2) {
        ...
        sprintf(errorMassage, "Coordinate::SetCoordinate error, dim = %d, coord = %c, Only x and y can be referenced.",
    ...
    if (this->Dimension() == 3) {
        ...
        sprintf(errorMassage,
                "Coordinate::SetCoordinate error, dim = %d, coord = %c, Only x, y and z can be referenced.",
                this->Dimension(), coord);
        PrintError(errorMassage);
        exit(1);
    }
...
Coordinate &Coordinate::SetCoordinate(double x, double y) {
    ...
    if (this->Dimension() != 2) {
        sprintf(errorMassage, "Coordinate::SetCoordinate error, dim = %d, Only x and y can be referenced.",
                this->Dimension());
        PrintError(errorMassage);
        exit(1);
    }
...
Coordinate &Coordinate::SetCoordinate(double x, double y, double z) {
    ...
    if (this->Dimension() != 3) {
        sprintf(errorMassage, "Coordinate::SetCoordinate error, dim = %d, Only x, y and z can be referenced.",
                this->Dimension());
        PrintError(errorMassage);
        exit(1);
    }
...
double &Coordinate::Value(char coord) const {
    ...
    if (this->Dimension() == 2) {
        ...
        sprintf(errorMassage, "Coordinate::Value error, dim = %d, coord = %c, Only x and y can be referenced.",
                this->Dimension(), coord);
        PrintError(errorMassage);
        exit(1);
    }
    ...
    if (this->Dimension() == 3) {
        ...
        sprintf(errorMassage, "Coordinate::Value error, dim = %d, coord = %c, Only x, y and z can be referenced.",
                this->Dimension(), coord);
        PrintError(errorMassage);
        exit(1);
    }
...
double Coordinate::Distance(const Coordinate &src) {
    ...
    if (this->Dimension() != src.Dimension()) {
        sprintf(errorMassage, "Coordinate::Distance error, this dimension = %d, but source dimension = %d",
