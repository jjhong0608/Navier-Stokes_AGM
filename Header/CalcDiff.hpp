...
void SettingDiffCoefficient(Point *pt, xData *xdat, yData *ydat,
    ...
    if (!pt->IsBoundary('W')) xdat->Cphi += 5.0E-1 * greens_integral_tau(2, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    if (!pt->IsBoundary('E')) xdat->Cphi += 5.0E-1 * greens_integral_tau(3, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 phi의 국소 x-축선에서 끝점에서의 계수
    if (!pt->IsBoundary('E')) xdat->Ephi = 5.0E-1 * greens_integral_tau(4, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 phi의 국소 x-축선에서 시작점에서의 계수
    if (!pt->IsBoundary('W')) xdat->Wphi = 5.0E-1 * greens_integral_tau(1, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 f의 현재점에서의 계수
    if (!pt->IsBoundary('W')) xdat->Cf += 5.0E-1 * greens_integral_tau(2, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    if (!pt->IsBoundary('E')) xdat->Cf += 5.0E-1 * greens_integral_tau(3, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 f의 국소 x-축선에서 끝점에서의 계수
    if (!pt->IsBoundary('E')) xdat->Ef = 5.0E-1 * greens_integral_tau(4, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 f의 국소 x-축선에서 시작점에서의 계수
    if (!pt->IsBoundary('W')) xdat->Wf = 5.0E-1 * greens_integral_tau(1, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    ...
    if (!pt->IsBoundary('S')) ydat->Cphi += -5.0E-1 * greens_integral_tau(2, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    if (!pt->IsBoundary('N')) ydat->Cphi += -5.0E-1 * greens_integral_tau(3, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 phi의 국소 y-축선에서 끝점에서의 계수
    if (!pt->IsBoundary('N')) ydat->Nphi = -5.0E-1 * greens_integral_tau(4, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 phi의 국소 y-축선에서 시작점에서의 계수
    if (!pt->IsBoundary('S')) ydat->Sphi = -5.0E-1 * greens_integral_tau(1, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 f의 현재점에서의 계수
    if (!pt->IsBoundary('S')) ydat->Cf += 5.0E-1 * greens_integral_tau(2, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    if (!pt->IsBoundary('N')) ydat->Cf += 5.0E-1 * greens_integral_tau(3, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 f의 국소 y-축선에서 끝점에서의 계수
    if (!pt->IsBoundary('N')) ydat->Nf = 5.0E-1 * greens_integral_tau(4, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 f의 국소 y-축선에서 시작점에서의 계수
    if (!pt->IsBoundary('S')) ydat->Sf = 5.0E-1 * greens_integral_tau(1, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
...
void SettingDiffDiffCoefficient(Point *pt, xData *xdat, yData *ydat,
    ...
    // 국소 x-축선에서 phi의 현재점에서의 계수
    if (!pt->IsBoundary('W')) xdat->Cphi += -5.0E-1 * greens_integral_ttau(2, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    if (!pt->IsBoundary('E')) xdat->Cphi += -5.0E-1 * greens_integral_ttau(3, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 phi의 국소 x-축선에서 끝점에서의 계수
    if (!pt->IsBoundary('E')) xdat->Ephi = -5.0E-1 * greens_integral_ttau(4, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 phi의 국소 x-축선에서 시작점에서의 계수
    if (!pt->IsBoundary('W')) xdat->Wphi = -5.0E-1 * greens_integral_ttau(1, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 f의 현재점에서의 계수
    if (!pt->IsBoundary('W')) xdat->Cf += -5.0E-1 * greens_integral_ttau(2, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    if (!pt->IsBoundary('E')) xdat->Cf += -5.0E-1 * greens_integral_ttau(3, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 f의 국소 x-축선에서 끝점에서의 계수
    if (!pt->IsBoundary('E')) xdat->Ef = -5.0E-1 * greens_integral_ttau(4, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 x-축선에서 f의 국소 x-축선에서 시작점에서의 계수
    if (!pt->IsBoundary('W')) xdat->Wf = -5.0E-1 * greens_integral_ttau(1, xm, xb, xp, xb, yb, 1, bdx, mpx1, mpx2);
    // 국소 y-축선에서 u의 현재점에서의 계수
    // ydat->Cu = - 1.0E0;
    // 국소 y-축선에서 u의 국소 y-축선에서 끝점에서의 계수
    ...
    // 국소 y-축선에서 phi의 현재점에서의 계수
    if (!pt->IsBoundary('S')) ydat->Cphi += 5.0E-1 * greens_integral_ttau(2, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    if (!pt->IsBoundary('N')) ydat->Cphi += 5.0E-1 * greens_integral_ttau(3, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 phi의 국소 y-축선에서 끝점에서의 계수
    if (!pt->IsBoundary('N')) ydat->Nphi = 5.0E-1 * greens_integral_ttau(4, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 phi의 국소 y-축선에서 시작점에서의 계수
    if (!pt->IsBoundary('S')) ydat->Sphi = 5.0E-1 * greens_integral_ttau(1, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 f의 현재점에서의 계수
    if (!pt->IsBoundary('S')) ydat->Cf += -5.0E-1 * greens_integral_ttau(2, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    if (!pt->IsBoundary('N')) ydat->Cf += -5.0E-1 * greens_integral_ttau(3, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 f의 국소 y-축선에서 끝점에서의 계수
    if (!pt->IsBoundary('N')) ydat->Nf = -5.0E-1 * greens_integral_ttau(4, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
    // 국소 y-축선에서 f의 국소 y-축선에서 시작점에서의 계수
    if (!pt->IsBoundary('S')) ydat->Sf = -5.0E-1 * greens_integral_ttau(1, ym, yb, yp, xb, yb, 2, bdy, mpy1, mpy2);
...
double CalcDiffDiff(char xy, Point *pt, xData *xdat, yData *ydat) {
    ...
    // x-성분의 미분을 계산하는 경우
    if (xy == 'X' || xy == 'x') {
        returnval =  - (5.0E-1 * (HeadVelocity(pt)->F() + arrVal[13])) / HeadVelocity(pt)->MaterialProperty();
        if (::SolverType) {
            ...
            returnval -= 5.0E-1 * HeadVelocity(pt)->Phi()->Pre()->Value() / HeadVelocity(pt)->MaterialProperty();
        }
        return returnval;
        arrEnt[0] = xdat->Cu, arrEnt[1] = xdat->Eu, arrEnt[2] = xdat->Wu, arrEnt[5] = xdat->ENu, arrEnt[6] = xdat->ESu, arrEnt[7] = xdat->WNu, arrEnt[8] = xdat->WSu,
        arrEnt[13] = xdat->Cphi, arrEnt[14] = xdat->Ephi, arrEnt[15] = xdat->Wphi, arrEnt[18] = xdat->ENphi, arrEnt[19] = xdat->ESphi, arrEnt[20] = xdat->WNphi, arrEnt[21] = xdat->WSphi,
