...
public:
    ...
    Section &setElt(Line2D *ln2d) {
        SL2D = ln2d;
        return *this;
    }

    Section &setElt(Triangle *tr3d) {
        SL3D = tr3d;
        return *this;
    }
...
public:
    ...
    Thing_AxialLine &SetNline(int nl) {
        nline = nl;
        return *this;
    }
...
public:
    ...
    int XYaxial_Num(char) const;

    int XXYYaxial_Num(char) const;
    ...
    AxialData &LoadAxialData(const string &);
...
public:
    ...
    Point &SetNormal(const Coordinate &);
...
// 해의 표현식의 계수의 확인
double
CheckRepresentationFormula(Point *, xData *, yData *, int, double, double, double, double, double, double, int, int);
...
//
void InitializationCoef(xData *, yData *, const string &);

//
void SettingGreenShape(Point *, int *, int *);

//
void SettingCoefficient(Point *, xData *, yData *, double, double, double, double, double,
                        double, int, int, double, double, double, double,
                        int, bool);

//
void SettingNeumannCoefficient(Point *, xData *, yData *, double, double, double, double,
                               double, double, int, int, double, double,
                               double, double, bool);

//
void SettingDirichletCoefficient(Point *, xData *, yData *, double, double, double, double,
                                 double, double, int, int, double, double,
                                 double, double, int, bool);

//
void
SettingDiffCoefficient(Point *, xData *, yData *, double, double, double, double, double,
                       double, int, int, double, double, double, double);

//
void SettingDiffDiffCoefficient(Point *, xData *, yData *, double, double, double, double,
                                double, double, int, int, double, double,
                                double, double);

//
void
SettingTimeIntegration(Point *, xData *, yData *, double, double, double, double, double,
                       double, int, int, double, double, double, double,
                       bool);

//
void SettingDiffTimeIntegration(Point *, xData *, yData *, double, double, double, double,
                                double, double, int, int, double, double,
                                double, double);

//
void SettingNeumannTimeIntegration(Point *, xData *, yData *, double, double, double, double,
                                   double, double, int, int, double, double,
                                   double, double, bool);

//
void SettingTimeIntegrationRightHand(Point *, xData *, yData *, double, double, double, double,
                                     double, double, int, int, double, double,
                                     double, double, bool);

//
void
SettingDiffTimeIntegrationRightHand(Point *, xData *, yData *, double, double, double, double,
                                    double, double, int, int, double, double,
                                    double, double);

//
void SettingDiffDiffTimeIntegrationRightHand(Point *, xData *, yData *, double, double, double,
                                             double, double, double, int, int,
                                             double, double, double, double);

//
void SettingNeumannTimeIntegrationRightHand(Point *, xData *, yData *, double, double, double,
                                            double, double, double, int, int,
                                            double, double, double, double, bool);

//
void
SettingNeumannTimeIntegrationRightHandCoefficient(Point *, xData *, yData *, double, double, double,
                                                  double, double, double, int, int,
                                                  double, double, double, double, bool);

//
void
SettingDirichletTimeIntegrationRightHand(Point *, Point *, xData *, yData *, double, double, double,
                                         double, double, double, int, int, double,
                                         double, double, double, bool);

//
void SettingLaplaceRightHand(Point *, xData *, yData *, double, double, double, double,
                             double, double, int, int, double, double,
                             double, double, bool);

//
void SettingNeumannLaplaceRightHand(Point *, xData *, yData *, double, double, double, double,
                                    double, double, int, int, double, double,
                                    double, double, bool);

void SettingDirichletLaplaceRightHand(Point *, Point *, xData *, yData *, double, double, double,
                                      double, double, double, int, int, double,
                                      double, double, double, bool);

//
void
SettingDiffLaplaceRightHand(Point *, xData *, yData *, double, double, double, double, double, double, int, int, double,
                            double, double, double);

//
void
SettingDiffDiffLaplaceRightHand(Point *, xData *, yData *, double, double, double, double, double, double, int, int,
                                double, double, double, double);

//
void CalcInterfaceCoef(Point *, xData *, yData *, const char *, double, double, double, double,
                       double);

//
void CalcNeumannCoef(Point *, xData *, yData *, const char *, double, double, double, double,
                     double);

//
void ApproximateInterfacePt(Point *, xData *, yData *, double, double, double, double, double, double, double, double,
                            double, double, bool);

//
void
ApproximateDiffDiffPt(Point *, xData *, yData *, double, double, double, double, double, double, double, double, double,
                      double, bool);
