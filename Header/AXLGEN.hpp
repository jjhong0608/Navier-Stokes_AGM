...
int AXLGEN(const string& Geometry_filename, const string& AGL_output_file_TEMP, const string& AGM_output_file_TEMP, const double initialTime, const double terminalTime, const int timeStep, const double dt, int nIter) {
